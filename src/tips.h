...
#define SellErrorPosLand std::string("请输入正确的地块编号")
#define SellErrorOwnerLand std::string("不是你的地也想卖？")
...
#define FrameStr std::string("陷害成功")
#define FailFrameStr std::string("陷害失败")
...
#define UseBarrierStr std::string("成功使用了路障")
#define BuyRobotStr std::string("购买了一个机器娃娃")
#define UseRobotStr std::string("成功使用了机器娃娃")
